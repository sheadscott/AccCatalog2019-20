...
const Footer = props => (
  <StyledFooter>
    <Grid style={{ maxWidth: '960px' }}>
      ...
      <GridCell span="6">
        <TLED xmlns="http://www.w3.org/2000/svg" viewBox="0 0 415.3 228.7">
...
//         <li><Link to="http://www.austincc.edu/discover">About ACC</Link></li>
//         <li><Link to="http://www.austincc.edu/police">Campus Police</Link></li>
//         <li><Link to="http://www.austincc.edu/emergency-notifications">Emergency Information</Link></li>
//       </ul>
//     </div>
//     <div>
//       <ul className={listStyle}>
//         <li><Link to="http://www.austincc.edu/calendars/Linkcademic-calendar">Academic Calendar</Link></li>
//         <li ><Link to="http://www.austincc.edu/degrees-and-certificates/explore-educational-choices/Linkreas-of-study/programs-a-z">Academic &amp; Career Programs</Link></li>
//       </ul>
//     </div>
//     <div>
//       <ul className={listStyle}>
//         <li><Link to="http://www.austincc.edu/Linkpply-and-register/Linkdmission-steps">Admissions</Link></li>
//         <li><Link to="http://www.austincc.edu/locations/campuses">Campus Locations</Link></li>
//       </ul>
//     </div>
//     <div >
//       <div>
